  ...
  return (
    <div className="p-6 space-y-5 font-mono animate-pulse">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
        {[1, 2, 3].map((i) => (
          <div key={i} className="border-[2.5px] border-black/20 dark:border-white/20 bg-white/60 dark:bg-[#161821]/60 shadow-[4px_4px_0_0_rgba(0,0,0,0.1)] p-5 space-y-3">
      ...
      <div className="border-[2.5px] border-black/20 dark:border-white/20 bg-white/60 dark:bg-[#161821]/60 mt-4">
