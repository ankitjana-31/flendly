...
export function SelfTrackForm({ onSuccess }: SelfTrackFormProps) {
  ...
  return (
    <Card className="p-6">
      <h3 className="font-heading text-sm font-semibold mb-4">Add Personal Record</h3>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {success && (
          <div className="px-4 py-3 rounded-lg bg-success/10 text-success text-sm">
        ...
        <div className="flex gap-3 pt-2">
          <motion.button
            ...
            className="flex-1 px-4 py-2 rounded-lg bg-primary text-primary-foreground font-medium hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
          >
