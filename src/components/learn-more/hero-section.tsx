  ...
  return (
    ...
    >
      <RetroWindow
        ...
        contentClassName="p-8 sm:p-12 md:p-16 text-left"
        headerRight={
      ...
      >
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-black dark:text-white leading-[1.1] tracking-tight mb-8"
        >
        ...
        <motion.p
          variants={itemVariants}
          className="text-xl sm:text-2xl leading-relaxed text-gray-700 dark:text-gray-200 max-w-3xl mb-10 font-normal"
        >
        ...
        >
          <Link
            href="/auth/login"
            className="px-8 py-4 bg-[#FFE600] text-black border-[3px] border-black font-mono text-base font-black uppercase shadow-[4px_4px_0_0_#000] hover:bg-yellow-300 active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all flex items-center gap-2.5"
          >
            <span>⚡</span>
