  ...
  return (
    <section className="relative z-20 w-full max-w-6xl mx-auto mt-24 px-4 sm:px-6 pb-20">
      ...
      <div className="text-center mb-12">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-300 text-xs font-semibold mb-4 backdrop-blur-md">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition-all duration-200 border ${
                isActive
                  ...
                  : "bg-slate-900/60 border-slate-800 text-slate-400 hover:text-white hover:bg-slate-800/60 hover:border-slate-700"
              }`}
            >
      ...
      <div className="relative rounded-3xl border border-slate-700/60 bg-gradient-to-b from-slate-900/90 to-slate-950/95 backdrop-blur-2xl p-6 sm:p-10 shadow-2xl overflow-hidden">
        ...
        {activeTab === "dashboard" && (
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="p-5 rounded-2xl bg-slate-800/30 border border-slate-700/40 space-y-3">
                <h4 className="text-sm font-bold text-white flex items-center justify-between">
                  <span>Recent Transactions</span>
                  <span className="text-xs text-teal-400 font-normal">Auto-verified</span>
                </h4>
        ...
        {activeTab === "lent" && (
          ...
          >
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-xs text-teal-400">3 active borrowers</span>
            </div>
            {[
              ...
              <div key={deal.name} className="p-4 rounded-2xl bg-slate-800/30 border border-slate-700/40 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  <div className="flex items-center gap-2">
        ...
        {activeTab === "borrowed" && (
          ...
          >
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-xs text-rose-400">Clear repayment paths</span>
            </div>
            {[
        ...
        {activeTab === "notifications" && (
          ...
          >
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-xs text-blue-400">Zero spam</span>
            </div>
            {[
              ...
              <div key={idx} className={`p-4 rounded-2xl border transition-colors ${
                notif.unread ? "bg-blue-500/10 border-blue-500/30" : "bg-slate-800/20 border-slate-700/30"
