...
export default async function LentPage() {
  ...
  // Fetch loans where current user is the lender
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1.5 text-sm text-zinc-500 dark:text-zinc-400">
            Overview and settlement ledgers of money you have lent to others.
          </p>
        </div>

        <LoanListContainer loans={listItems} type="lent" />
      </div>
    </AuthedShell>
  );
}
